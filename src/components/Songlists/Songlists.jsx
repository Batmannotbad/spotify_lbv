...
export const Songlists = () => {
    ...
    const fetchSongData = async () => {
        try {
        const res = await fetch('http://localhost:5000/api/allsongs');
        if (res.ok) {
        ...
        <nav id="sidebar" className="d-flex justify-content-between flex-column fixed-left flex-shrink-0 bg-black m-2">
            <div className="wrapper d-flex flex-column gap-2">
                ...
                <div className="sidebar-option library">
                    ...
                    <div className="p-2 d-flex gap-2">
                        <img src="./assets/img/liked-song.png" className="liked-song "/>
                        <div className="">
                            ...
                            <div className="d-flex align-items-center gap-2">
                                ...
                                <span className="content">{songData.length} songs</span>
                            </div>
                        </div>
                    </div>
